...
void RectilinearConfigurationManager::create() {
  ...
  rc.add(scc1, IConnection(0, Connection(ConnectionPoint(NE, b1, true), ConnectionPoint(SW, b1, false))));
  /*std::cout << "Constructing and adding black brick: " << std::endl;
  rc.add(scc1, IConnection(0, Connection(ConnectionPoint(NW, b1, true), ConnectionPoint(SE, b1, false))));
